...
def create_timesheet(name_to_use, computercenter_contact_name):
    ...
    docx_replace_regex(doc, computercenter_contact_name_placeholder , computercenter_contact_name)
    ...
    file_path = "{0}-Timesheet-WC-{1}.docx".format(name.replace(" ", "-"), week_start.strftime("%d-%m-%Y"))
    doc.save(file_path)
